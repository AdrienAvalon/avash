> **Archive.** Ce document est le journal de développement d'avash, conservé pour
> mémoire : il retrace au jour le jour les décisions et les étapes de construction.
> Pour la présentation du projet, voir le [README](../README.md) ; pour
> l'architecture, [docs/architecture.md](architecture.md).
