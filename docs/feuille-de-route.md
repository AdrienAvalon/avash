...
|---|---|
| Tests | 338 Rust (147 cœur, 34 intégration, 62 interface, 95 processus RDP) · 585 dans les paquets IronRDP portés · 104 front · 52 scénarios bout en bout dans 26 fichiers, tous en intégration continue, sous Linux et — hors serveurs locaux — sous Windows |
