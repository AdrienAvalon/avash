...
|---|---|
| Tests | 332 Rust (147 cœur, 34 intégration, 62 interface, 89 processus RDP) · 387 dans les paquets IronRDP portés · 104 front · 52 scénarios bout en bout dans 26 fichiers, tous en intégration continue, sous Linux et — hors serveurs locaux — sous Windows |
