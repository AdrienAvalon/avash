...
[![Version](https://img.shields.io/badge/version-0.2.1-8b7cf6.svg)](CHANGELOG.md)
...
```bash
chmod +x Avash_0.2.1_amd64.AppImage
./Avash_0.2.1_amd64.AppImage
```
...
sha256sum Avash_0.2.1_x64-setup.exe
...
gh attestation verify Avash_0.2.1_x64-setup.exe --repo AdrienAvalon/avash
```
