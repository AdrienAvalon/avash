...
[![Tests](https://img.shields.io/badge/tests-806%20verts-brightgreen.svg)](#qualité)
...
**806 tests** couvrent le projet, tous exécutés à chaque commit :
...
| Intégration | 32 | contre un **vrai serveur SSH** : authentification et ses refus, PTY, SFTP, tunnels, rebonds `ProxyJump` ; l'outil en ligne de commande exercé comme binaire |
| Interface (`crates/avash-ui`) | 53 | commandes Tauri, magasin de sessions sur moteur factice (annulation pendant la connexion, éviction par époque), résolution des rebonds `ProxyJump`, décodage UTF-8 en flux, verrous clavier, annonce du processus RDP, variables d'environnement de la webview |
