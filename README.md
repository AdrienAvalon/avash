...
[![Tests](https://img.shields.io/badge/tests-1655%20verts-brightgreen.svg)](docs/qualite.md)
...
**1655 tests** à chaque commit, sur deux chaînes indépendantes (GitHub Actions
...
| Bout en bout (WebdriverIO) | 78 | l'application réelle, connexions SSH, RDP et VNC effectives, audit `axe-core` |
