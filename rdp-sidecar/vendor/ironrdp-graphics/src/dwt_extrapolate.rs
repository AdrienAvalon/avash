...
#[allow(clippy::similar_names, reason = "lw/hw/lh/hh are standard DWT band dimensions")]
...
#[allow(clippy::similar_names, reason = "hl/lh/hh/ll are standard DWT subband names")]
