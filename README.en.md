...
[![Tests](https://img.shields.io/badge/tests-1949%20passing-brightgreen.svg)](docs/qualite.md)
...
**1949 tests** on every commit, on two independent pipelines (GitHub Actions on
...
| Tauri interface | 202 | commands, session store, keyboard |
