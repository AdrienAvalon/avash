...
[![Tests](https://img.shields.io/badge/tests-1208%20passing-brightgreen.svg)](docs/qualite.md)
...
**1208 tests** on every commit, on two independent pipelines (GitHub Actions on
...
| RDP process | 133 | negotiation, graphics pipeline, VNC session, clipboard files, replay of real recordings, mutation fuzzing |
