...
[![Tests](https://img.shields.io/badge/tests-1629%20passing-brightgreen.svg)](docs/qualite.md)
...
**1629 tests** on every commit, on two independent pipelines (GitHub Actions on
Linux, Windows and macOS; a GitLab mirror with real xrdp servers):

| Level | Tests | In a word |
|---|---:|---|
| Rust core and integration against a real sshd | 306 | parsers, import, SFTP, tunnels, jump hosts |
| Tauri interface | 118 | commands, session store, keyboard |
| RDP process | 199 | negotiation, graphics pipeline, VNC session, clipboard files, replay of real recordings, mutation fuzzing |
