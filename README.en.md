...
[![Tests](https://img.shields.io/badge/tests-1125%20passing-brightgreen.svg)](docs/qualite.md)
...
**1125 tests** on every commit, on two independent pipelines (GitHub Actions on
...
| End to end (WebdriverIO) | 55 | the real application, actual SSH, RDP and VNC connections, `axe-core` audit |
