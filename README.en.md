...
[![Tests](https://img.shields.io/badge/tests-1169%20passing-brightgreen.svg)](docs/qualite.md)
...
**1169 tests** on every commit, on two independent pipelines (GitHub Actions on
...
| RDP process | 125 | negotiation, graphics pipeline, VNC session, clipboard files, replay of real recordings, mutation fuzzing |
...
| End to end (WebdriverIO) | 67 | the real application, actual SSH, RDP and VNC connections, `axe-core` audit |
